...
const SessionsByCountry: FC = function () {
  return (
    <div className="mb-4 rounded-lg bg-white p-4 shadow dark:bg-gray-800 sm:p-6 xl:mb-0 xl:p-8 2xl:col-span-2 w-full">
      <div className="mb-4">
  ...
  return (
    <div className="rounded-lg bg-white p-4 shadow dark:bg-gray-800 sm:p-6 xl:p-8">
      ...
      <div className="flex flex-row">
        <div className="flex w-1/2 my-6 justify-center">
          <AcquisitionChart />
        </div>
